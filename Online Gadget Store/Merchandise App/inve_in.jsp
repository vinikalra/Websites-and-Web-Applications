...
<head>
<meta charset="UTF-8" >
<title>Inventory Received</title>
...
<ul>
  <li class="active"><a href="/jadrn017/servlet/Merc_in">Inventory Received</a></li>
  <li><a href="/jadrn017/servlet/Merc_out">Inventory Sent</a></li>
...
<td>
<input type="button" value="Add to Inventory" width = "60px" id="inve_out" onclick="addToInv();">
</td>
</tr>
</div>
         </table>
